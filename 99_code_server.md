...
```sh
wget https://github.com/cdr/code-server/releases/download/2.1638-vsc1.39.2/code-server2.1638-vsc1.39.2-linux-x86_64.tar.gz
tar xvfz code-server2.1638-vsc1.39.2-linux-x86_64.tar.gz
sudo mv code-server2.1638-vsc1.39.2-linux-x86_64/code-server /usr/local/bin
mkdir ~/project
